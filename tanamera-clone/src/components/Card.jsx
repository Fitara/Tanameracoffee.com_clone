                ...
                <div>
                    ...
                    <div>
                        <a className="card shadow">
                            <img src="https://tanameracoffee.com/wp-content/uploads/2021/03/TC_BreakfastBlend1kg_230403.jpg" alt="" />
                            <div className="bg-gray-100">
                                <p className="text-base font-semibold tracking-wide mt-1">Breakfast Blend</p>
                                <p className="font-sans uppercase text-xs text-black font-bold tracking-widest mb-2">From IDR 260 K</p>
                            </div>    
                        </a>    
                    </div>
                    <div>
                    ...
                    <div>
                        <a className="card shadow">
                            <img src="https://tanameracoffee.com/wp-content/uploads/2021/03/The_Archipelago_Pack_100gr.jpg" alt="" />
                            <div className="bg-gray-100">
                                <p className="text-base font-semibold tracking-wide mt-1">The Archipelago Pack</p>
                                <p className="font-sans uppercase text-xs text-black font-bold tracking-widest mb-2">From IDR 490 K</p>
                            </div>
                        </a>    
                    </div>
                    <div>
                        <a className="card shadow">
                            <img src="https://tanameracoffee.com/wp-content/uploads/2021/03/TC_BundleBlend1kg_210226.jpg" alt="" />
                            <div className="bg-gray-100">
                                <p className="text-base font-semibold tracking-wide mt-1">The Blend Pack</p>
                                <p className="font-sans uppercase text-xs text-black font-bold tracking-widest mb-2">From IDR 799 K</p>
                            </div>
                        </a>    
                    </div>    
                    </div>  
